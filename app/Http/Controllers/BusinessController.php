...
class BusinessController extends Controller
{
    ...
    public function store(Request $request)
    {
        if (!$request->session()->get('IsAdmin')) {
            ...
            return redirect()->route('users.show', ['username' => $User->Link])->with('success', 'Business has been created successfully');
    ...
    public function update(Request $request, $id)
    {
        if (!$request->session()->get('IsAdmin')) {
            ...
            $User = Users::find($request->input('UserId'));
            return redirect()->route('users.show', ['username' => $User->Link])->with('success', 'Work has been Updated successfully');
